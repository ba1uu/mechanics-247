...
export default function AboutPage() {
  ...
  return (
    <div style={{ background: C.cream, minHeight: "100vh" }}>
      ...
      {/* Hero */}
      <section style={{ background: `linear-gradient(135deg, ${C.brown}, ${C.terra})`, padding: "120px 60px 80px", textAlign: "center" }}>
      ...
      <section style={{ padding: "80px 60px", background: C.white }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
          <div>
            ...
            <h2 style={{ fontFamily: "'Oswald',sans-serif", fontSize: 40, fontWeight: 700, color: C.textPrimary, marginBottom: 20 }}>
      ...
      {/* Timeline */}
      <section style={{ padding: "80px 60px", background: C.cream2 }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h2 style={{ fontFamily: "'Oswald',sans-serif", fontSize: 40, fontWeight: 700, color: C.textPrimary }}>From idea to <span style={{ color: C.amber }}>India's #1 platform</span></h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 2 }}>
            {milestones.map((m, i) => (
              <div key={i} style={{ background: C.white, padding: "28px 24px", borderRadius: i === 0 ? "16px 0 0 16px" : i === 3 ? "0 16px 16px 0" : 0, textAlign: "center", position: "relative" }}>
                ...
                {i < 3 && <div style={{ position: "absolute", right: -10, top: "50%", transform: "translateY(-50%)", width: 20, height: 20, background: C.amber, clipPath: "polygon(0 0,100% 50%,0 100%)", zIndex: 2 }} />}
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: "80px 60px", background: C.cream2 }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h2 style={{ fontFamily: "'Oswald',sans-serif", fontSize: 40, fontWeight: 700, color: C.textPrimary }}>What we <span style={{ color: C.amber }}>stand for</span></h2>
          </div>
      ...
      {/* CTA */}
      <section style={{ padding: "80px 60px", background: C.brown, textAlign: "center" }}>
